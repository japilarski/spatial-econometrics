...
Model to błędny model autoregresji przestrzennej (SEM) — czyli zakładamy, że zależności przestrzenne są zawarte w składniku losowym (błędzie modelu), a nie bezpośrednio w zmiennej zależnej.
...
N <- length(sem_model$fitted.values) # Liczba obserwacji w modelu SEM

SSR_sem <- sem_model$s2 * N # Resztowa suma kwadratów (SSR) — s2 to wariancja reszt z modelu SEM
